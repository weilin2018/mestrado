...
if __name__=='__main__':
 ...
 #               vento.write("\n")
    ...
    arquivo  = '/media/danilo/Danilo/mestrado/artigo_data/CFSR/guaiba/' #onde esta o dado de vento .nc
    nc    = '*.nc'
    f_mg  = '/media/danilo/Danilo/mestrado/github/artigoTG/grade/model_grid_comterra' #model grid com pontos em Terra.
    ...
    ano             = 2014
    mes             = 01
    wind_multiplier = 2. # atualizar ali embaixo na formula!
    file_name       = 'vento_guaiba_x2.0'#+str(ano)+str(mes)
    ...
    for file_i,nc in enumerate(ncfiles):
        ...
        t = wndnc.u.shape[0]
        U,V,P = interp.to_secom(t,intp_flag,xwind_multiplier=wind_multiplier,ywind_multiplier=wind_multiplier)
