...
ax.text(x,y,u'Eastern\nPortion',color='#800000', fontsize=8, ha='right',va='baseline')
...
m.scatter(x,y,s=8,c='k',marker='o',zorder=2)
...
plt.savefig('/media/danilo/Danilo/mestrado/github/artigoTG/figures/Fig1_version1.png',dpi=600)
