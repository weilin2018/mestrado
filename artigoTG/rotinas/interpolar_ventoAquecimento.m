...
dias_simulados = 15; % total de dias que serão simulados

% vetor de tempo
tempo = [0:6:dias_simulados*24+6]; 
cont_tempo = 1;

disp('Inicio da leitura dos arquivos')

%% fazer para o primeiro arquivo (21/Dezembro/1996) - Aquecimento do modelo
k=1;
...
% aqui é só colocar no arquivo uma repeticao o ultimo instante salvo nele
...
%% remover arquivos gerados pela leitura do grib2
...
wind_print= sprintf('#      wind.f: %i', jhm+1); 
