...
CAM_SAM <- "C:/ML/ICTP_2018_ESD_Training/GSN_CAM_SAM/"
...
#First station
#plot(time, example1$Data[,1], ty = 'l', col = "blue", xlab = "time", ylab = "T (ºC)",ylim=c(-10, 30))
#Second station
...
slp <- loadGridData(dataset = "C:/ML/ICTP_2018_ESD_Training/R1/slp.R1.1978a2014.SA.nc",
...
T850 <- loadGridData(dataset = "C:/ML/ICTP_2018_ESD_Training/R1/air.R1.1978a2014.SA.nc",
                     var = "air@850",lonLim=c(-60.0,-47.5),latLim=c(-37.5,-30.0),season = seas, years = yrs)

q850 <- loadGridData(dataset = "C:/ML/ICTP_2018_ESD_Training/R1/shum.R1.1978a2014.SA.nc",
...
analog.cv2 <- downscale.cv(x = x2, y = y, method = "analogs",folds = 5, type = "chronological", n.analogs = 1, 
