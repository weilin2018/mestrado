...
slp.HIST <- loadGridData(dataset = "/home/aluno/ICTP_2018_ESD_Training/HistoricalCSIRO/slp.CSIRO.1970a2005.SA.nc",
                        var = "slp",lonLim=c(-65.0,-50.0),latLim=c(-37.5,-25.0),season = seas, years = yrsH)

T850.HIST <- loadGridData(dataset = "/home/aluno/ICTP_2018_ESD_Training/HistoricalCSIRO/air.CSIRO.1975a2005.SA.85000.nc",
                          var = "air",lonLim=c(-60.0,-47.5),latLim=c(-37.5,-30.0),season = seas, years = yrsH)

q850.HIST <- loadGridData(dataset = "/home/aluno/ICTP_2018_ESD_Training/HistoricalCSIRO/shum.CSIRO.1975a2005.SA.85000.nc",
...
Tmin.HIST <- loadGridData(dataset = "/home/aluno/ICTP_2018_ESD_Training/HistoricalCSIRO/tasmin.CSIRO.1990a2005.nc",
...
slpRCP45 <- loadGridData(dataset = "/home/aluno/ICTP_2018_ESD_Training/RCP4.5CSIRO/slp.CSIRO.2086a2100.SA.nc",
                    var = "slp",lonLim=c(-60.0,-47.5),latLim=c(-37.5,-30.0),season = seas, years = 2086:2100)

T850RCP45 <- loadGridData(dataset = "/home/aluno/ICTP_2018_ESD_Training/RCP4.5CSIRO/air.CSIRO.2086a2100.SA.850.nc",
                     var = "air",lonLim=c(-60.0,-47.5),latLim=c(-37.5,-30.0),season = seas, years = 2086:2100)

q850RCP45 <- loadGridData(dataset = "/home/aluno/ICTP_2018_ESD_Training/RCP4.5CSIRO/shum.CSIRO.2086a2100.SA.850.nc",
