...
def plotar_dado2(fig,ax,k1,item,horas,cbPlot=False,location='bigmap.p'):
    ...
    if cbPlot:
        ...
        # plotar a legenda da colorbar
        cb.set_label('Concentração Integrada de Trítio \n (x$10^{7}Bq.m^{-3}$)',fontsize=15)
...
def criar_figura2(savefig=False):
    ...
    # extract data
    neConc, swConc = totalConcentration(i, pkl="/home/tparente/danilo/mestrado/congressos/omarsat_2017/rotinas/arquivos/totalConc.pkl")
