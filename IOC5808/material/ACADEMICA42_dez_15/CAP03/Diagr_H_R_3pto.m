  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
  % PLOTA UM CONJUNTO DE TRÊS PARES DE PARÂMETROS ESTRATIFICAÇÃO  (pe)%
  % x CIRCULAÇÃO (pc) NO DIAGRAMA ESTRATIFICAÇÃ0-CIRCULAÇÃO           %
  % DE HANSEN & RATTRAY (1966)                                        %
  % PROGRAMA PREPARADO POR FERNANDO PINHEIRO ANDUTTA (2006)           %
...
% Entrada dos três pares de parâmetros 
...
if language==1;
   ...
   axe_Y = ['Parâmetro estratificação','fontsize',16];
   ylabel(axe_Y); 
...
if salva==1
print -dbitmap e:\Academica42\cap03\Diagr_3pto.bmp
      %end
