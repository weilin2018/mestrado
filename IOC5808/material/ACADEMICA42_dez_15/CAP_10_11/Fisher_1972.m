...
% estacionários com cálculo dos componente longitudinal (u) e  %
% vertical (w) de velocidade e comparação com dados            %
% experimentais.                                               %
% A simulação considera atrito máximo e moderado               %
% (com escorregamento de fundo - "u" de fundo é dif. de 0)     %
...
% Programação: Marcos Eduardo Cordeiro Bernardes - 2001        % 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% uf: Velocidade da descarga de água fluvial (m/s)               %
...
% UD: Velocidade teórica gerada pelo gradiente de densidade (m/s)%
% UR: Velocidade teórica gerada pela descarga de água doce (m/s) %
% UV: Velocidade teórica gerada pelo vento (m/s)                 %
...
% WD: Velocidade teórica gerada pelo gradiente de densidade (m/s)%
% WV: Velocidade teórica gerada pelo vento (m/s)                 %
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Devido ao fato das estações realizadas no Mar de Cananeia       %
% apresentarem uma orientação de eixos diferente do convencional  %
% (no Mar de Cananeia, valores positivos de veloc. representariam %
% correntes estuário acima e nao abaixo, como comumente conven-   %
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Equação simplificada do estado linear %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Ro=1000*(1+(Beta.*s));

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Cálculo da amplitude da velocidade gerada           %
% pela maré U0, com base na celeridade da onda        %
% assumindo que a propagação da maré é progressiva-   %
% e sem atrito Miranda et al. 2012  - eq. 2.20 -      %
% p. 76. A amplitude da velocidade gerada pela maré   %
% é calculada em função da profundidade h             %
% eq. 2.23 - p. 77                                    %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Cálculo do coeficiente de viscosidade turbulenta Az  %
% e seu valor médio                                    %
% Miranda et al. 2002 - equação 10.29 p. 347           %
% ou Miranda et al. 2012 - equação 10.29 p. 355        %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Cálculo da tensão de cisalhamento do fundo (TCF)      %
% em função do gradiente longitudinal de densidade      %
% da amplitude da velocidade gerada pela maré Uo, da    %
% descarga fluvial e da tensão de cisalhamento do       %
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Estratificacao verticalmente homogênea         %
% Soluçâo com escorregamento                     %
% Miranda et al. 2002 - equação 10.29 p. 351     %
% ou Miranda et al. 2012 - equação 10.49 p. 359  %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Cálculo do perfil teórico da velocidade u        % 
% Solução sem escorregamento                       %
% Miranda et al. 2002 - equação 10.33 p. 348       %
% ou Miranda et al. 2012 - equação 10.33 9 p. 356  %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Estratificação parcialmente misturada %
% Solução com escorregamento            %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Cálculo do perfil teórico do componente vertical %
% da velocidade w                                  %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Cálculo do perfil teórico da velocidade w  %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% As velocidades verticais estão com sinal negativo p/%
% que os referenciais utilizados sejam padronizados   %
% (modelo original o referencial cresce para baixo,   %
% enquanto os resultados estão sendo apresentados     %
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Solução com atrito máximo de fundo %
