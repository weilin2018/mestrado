...
% Médias espacial e temporal p. 166 e seguintes       %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%	curva em vermelho: dado interpolado
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	% Leitura dos dados hidrográficos          %
    % separando da matriz de dados             %
    % as variáveis: profundidade, temperatura, % 
   ...
   dens=hidro_quad(:,4);
    ...
    % permitindo o controle de qualidade das interpolações         %
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
   % Organiza todas as estações para um ciclo de maré (13 perfis horários)%
   % separando em dados amostrados em intervalos horários (primeira opção)%
   % ou a cada meia hora (26 perfis), segunda opção escolhida             %                
   % neste exemplo                                                        % 
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%	end
    ...
    % Observe que são em número de 26
    % pois o intervalo de amostragem é
    % é 30 minutos
