...
%  neste programa o nome desse arquivo de dados é vel_quad.dat%	  
  ...
  load e:\Academica42_maio_14\CAP05\vel_quad.dat
  ...
  diary veloc.txt
    ...
    % e a rotação do eixo x (B) em 45 graus no sentido anti-horário.            %
    ...
    % Permitindo o controle de qualidade dos dados obtidos         %
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
,' ;z',num2str(i+24),' ;z',num2str(i+25),'];'];
   ...
   figure
        ...
        print -dbitmap f:\testedecomp\h_t_quad.bmp
    ...
    %save f:\estuario\programas\cap5\u_22_08.dat u_22_08 -ascii		   % dados de entrada para 
	%save f:\estuario\programas\cap5\v_22_08.dat v_22_08 -ascii		   %	   surfer
    %save f:\estuario\programas\cap5\zl_22_08.dat zl_22_08 -ascii	

	%save f:\estuario\programas\cap5\zl_22_08.dat zl_22_08 -ascii    % dados de entrada para
	%save f:\estuario\programas\cap5\vl_22_08.dat vl_22_08 -ascii      %	estuario.m
