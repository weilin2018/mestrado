...
% FOI UTILIZADA A EQUAÇÃO DE MIRANDA et al. 2011 (eq. 5.11 - p. 160) %
% PARA MAIS DETALHES, CONSULTAR % Bérgamo et al. (2002),             %
...
cr=input('Digite o numero do arquivo:');
   ...
   % Converte para módulo velocidade e de cm/s se necessário m/s
  ...
  %vu=abs(vu)/100;
   ...
   print -dbitmap f:\ESTUARIO\PROGRAMAS\CAP5\figura1.bmp
   ...
   print -dbitmap f:\ESTUARIO\PROGRAMAS\CAP5\figura2.bmp
 ...
 % Calculo da velocidade de atrito u*
   ...
   print -dbitmap f:\ESTUARIO\PROGRAMAS\CAP5\figura3.bmp
   ...
   print -dbitmap f:\ESTUARIO\PROGRAMAS\CAP5\figura4.bmp
