...
% We defined four theme colors: UniDarkBlue, UniBlue, UniGold
% and UniOrange. For example, to write some uniud-brownish
% text, just use: \textcolor{UniDarkBlue}{Hello!}
...
\title[Um beamer template adaptado do overleaf]{Um beamer template adaptado do overleaf}
\date[Outubro 2017]{Outubro 26, 2017}
\author[Dalton Kei Sasaki]{
  Dalton Kei Sasaki.
  \pdfnewline
  \texttt{dalton.sasaki@gmail.br}
}
\institute{Instituto Oceanográfico, USP}
...
\item \textcolor{white}{\marker[UniDarkBlue]{\texttt{UniDarkBlue}}}
