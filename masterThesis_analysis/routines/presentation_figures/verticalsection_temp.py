...
var = 'temp'                        # property to be ploted
cmap= cmo.cm.thermal                # type of colorbar to be used in contourf
contours = np.arange(11,35,0.5)     # contours to be used as resolution of the colorbar
levels = [18.]                      # to be used in contour (plot isoline)

outName= 'tempSection' + extension
