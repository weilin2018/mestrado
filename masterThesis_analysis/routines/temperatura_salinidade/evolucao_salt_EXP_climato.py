...
contours = np.arange(34.1,36.1,0.1)
...
# plotting colorbar
# cbar = plt.colorbar(cf1,orientation='horizontal',cax=caxes,format='%.1f')
cbar = plt.colorbar(cf1,ticks=[34.1,34.9,35.25,35.6,36.],orientation='horizontal',cax=caxes,format='%.1f')
...
plt.savefig('/home/danilo/Dropbox/mestrado/figuras/secoes_verticais/evolucao_salt_%s_climato.eps'%(exp))
plt.savefig('/home/danilo/Dropbox/mestrado/figuras/lowResolution/secoes_verticais/evolucao_salt_%s_climato.png'%(exp))
plt.close()
%reset -f
