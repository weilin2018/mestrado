...
for nstep in timestep:
    ...
    contours = np.arange(34.5,36,0.01)
    ...
    cbar = plt.colorbar(cf1,orientation='horizontal',cax=cax,format='%.1f')
    ...
    plt.savefig('/home/danilo/Dropbox/mestrado/figuras/composicao/salt/EC1/%s.eps'%(output_fname))
