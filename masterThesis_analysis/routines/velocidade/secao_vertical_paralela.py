...
for ind in indexes:
    ...
    cf1  = axes[axesInd].contourf(xgrid,-zgrid,Vplot,contours,cmap=cmo.cm.delta,extend='both')
    # cs   = axes[axesInd].contour(xgrid,-zgrid,Vplot,levels=[18.],colors=('k'),linestyles=('--'))
...
plt.savefig('/home/danilo/Dropbox/mestrado/figuras/secoes_verticais/secao_paralela_%s.pdf'%(exp))
plt.savefig('/home/danilo/Dropbox/mestrado/figuras/lowResolution/secoes_verticais/secao_paralela_%s.png'%(exp),dpi=300)
plt.close()
%reset -f
