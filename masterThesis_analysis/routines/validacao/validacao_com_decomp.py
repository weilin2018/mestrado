...
def rotaciona(u,v,mag,rot):
    ...
    intensity,direction = dp.uv2intdir(u,v,0,0)
    urotacion,vrotacion = dp.intdir2uv(intensity,direction,mag,rot)

    return urotacion,vrotacion
...
ur,vr = rotaciona(u,v,magnetic,-angleRot) # rotating vectors
# creating dataframe
...
ur,vr = rotaciona(u,v,0,-alpha) # rotating vectors
