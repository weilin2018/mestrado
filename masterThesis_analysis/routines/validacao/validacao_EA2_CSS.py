...
axes[0].set_ylabel('u ['+r'$m.s^{-1}$'+']',fontsize=8,labelpad=-2)
...
axes[1].set_ylabel('v ['+r'$m.s^{-1}$'+']',fontsize=8,labelpad=-2)
...
axes[2].set_ylabel('u ['+r'$m.s^{-1}$'+']',fontsize=8,labelpad=-2)
...
axes[3].set_ylabel('v ['+r'$m.s^{-1}$'+']',fontsize=8,labelpad=-2)
