...
plt.tight_layout()
plt.subplots_adjust(top=1.0,bottom=0.0,left=0.139,right=0.976,hspace=0.2,wspace=0.2)
plt.savefig(BASE_DIR + 'masterThesis_analysis/figures/experiments_outputs/loc_secoesVerticais.pdf')
